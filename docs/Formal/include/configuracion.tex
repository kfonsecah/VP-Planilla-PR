...
% Actualización de la configuración de los títulos de partes y capítulos
\let\Oldpart\part
\newcommand{\parttitle}{}
...
\fancyhead[L]{\leftmark} % Título del capítulo a la izquierda
\fancyhead[R]{\thepage}  % Número de página a la derecha
\fancyfoot{}             % Sin contenido en el pie de página

% Ajuste de las líneas de cabecera y pie de página
\renewcommand{\headrulewidth}{0.5pt} % Línea bajo la cabecera
\renewcommand{\footrulewidth}{0.5pt} % Línea sobre el pie de página (opcional)
