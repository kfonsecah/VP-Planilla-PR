...
\subsubsection{Interfases con software}
...
\subsubsection{Interfases de comunicación}
...
\begin{itemize}
	\item \textbf{Administrador:} Usuario principal del sistema, con experiencia en gestión administrativa. Es responsable de registrar y mantener los datos del personal, eventos laborales, generar la nómina y emitir reportes oficiales. Tiene acceso total a todos los módulos del sistema.
	\item \textbf{Empleados:} Tendrán acceso restringido y únicamente podrán consultar su información personal y comprobantes de pago. No interactúan con los procesos internos de cálculo ni administración de nómina.
\end{itemize}
...
El modelo de negocio se centra en optimizar la gestión de nóminas del personal de la empresa Café y Vivero Verde Pradera. A continuación, se enumeran los principales procesos:

\begin{itemize}
	\item Ingreso al sistema (autenticación)
	\item Registro y administración de empleados
	\item Registro de eventos laborales
	\item Cálculo automático de salarios
	\item Generación de reportes oficiales
