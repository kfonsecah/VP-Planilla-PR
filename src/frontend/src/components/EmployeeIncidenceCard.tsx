...
const EmployeeIncidenceCard: React.FC<EmployeeIncidenceCardProps> = ({ faltaTiempo, llegadaTardia, sobraTiempo, sinMarcas }) => {
  return (
    <div className="bg-[#FCF1D5] p-4 rounded-lg min-w-[220px]">
      <div className="mb-2 text-sm font-semibold text-black">Días con incidencia</div>
      <ul className="text-xs text-[#5D4E37]">
