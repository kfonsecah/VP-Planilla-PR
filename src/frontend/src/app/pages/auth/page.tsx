...
import {
  ...
  EyeSlashIcon,
  ArrowRightIcon,
} from "@heroicons/react/24/outline"; // Import icons for password toggle and button
...
const LoginScreen = () => {
  ...
  return (
    ...
    <div className="flex items-center self-start mb-auto"> {/* self-start pushes it to the top */}
        {/* Logo */}
        <Image
    ...
    <form onSubmit={handleSubmit} className="w-full max-w-sm mx-auto mt-auto"> {/* mx-auto to center, mt-auto to push to bottom */}
        <div className="mb-6">
            <label
      ...
      <div
        className="flex-1 bg-[#344838] relative overflow-hidden rounded-r-lg"
      >
        ...
        <Image
          src="/LogInBackground.png" // This is the image that needs to be tinted green
