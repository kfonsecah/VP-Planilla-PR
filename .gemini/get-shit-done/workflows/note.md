...
- **Global scope**: `C:/Users/Administrador/Desktop/U-Local/Vp-Planilla/.gemini/notes/{YYYY-MM-DD}-{slug}.md` — fallback when no `.planning/`, or when `--global` flag is present
...
2. Ensure the notes directory exists (`.planning/notes/` or `C:/Users/Administrador/Desktop/U-Local/Vp-Planilla/.gemini/notes/`)
...
2. Glob `C:/Users/Administrador/Desktop/U-Local/Vp-Planilla/.gemini/notes/*.md` (if directory exists) — global notes
...
Global (C:/Users/Administrador/Desktop/U-Local/Vp-Planilla/.gemini/notes/):
...
2. **No `.planning/`**: Falls back to global `C:/Users/Administrador/Desktop/U-Local/Vp-Planilla/.gemini/notes/` — works in any directory
