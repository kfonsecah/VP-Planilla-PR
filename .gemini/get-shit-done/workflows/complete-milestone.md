...
```bash
node "C:/Users/Administrador/Desktop/U-Local/Vp-Planilla/.gemini/get-shit-done/bin/gsd-tools.cjs" audit-open 2>/dev/null
```
...
**If doesn't exist:** Create from template at `C:/Users/Administrador/Desktop/U-Local/Vp-Planilla/.gemini/get-shit-done/templates/retrospective.md`.
