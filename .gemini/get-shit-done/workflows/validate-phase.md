...
```
Task(
  prompt="Read C:/Users/Administrador/Desktop/U-Local/Vp-Planilla/.gemini/agents/gsd-nyquist-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `C:/Users/Administrador/Desktop/U-Local/Vp-Planilla/.gemini/get-shit-done/templates/VALIDATION.md`
