...
```bash
INIT=$(node "C:/Users/Administrador/Desktop/U-Local/Vp-Planilla/.gemini/get-shit-done/bin/gsd-tools.cjs" init phase-op "${PHASE}")
...
Use the SPEC.md template from @C:/Users/Administrador/Desktop/U-Local/Vp-Planilla/.gemini/get-shit-done/templates/spec.md.
